...
def parse_arguments():
    ...
    parser.add_argument('-l', required=True, help="the leadSNP from FUMA with annovar format and corredted ref,alt(GenomicRiskLoci.txt.annovar.fa)")
...
def main(args=None):
    ...
    for line in leadfile:
        ...
        id = fields[5]
        pvalue = fields[7]
        wfile.write(str(locus_no) + "\t" + id + "\t" + rsid + "\t" + pvalue + "\tNA\n")
        cma = rsid + "_locus.cma.cojo"
